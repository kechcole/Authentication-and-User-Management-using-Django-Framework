...
SECRET_KEY = 'django-insecure-)75__g$nq_!+m*#k)xa#62op&yb616r%#ie)#&4(fzy4r=m6!u'
...
INSTALLED_APPS = [
    ...
    'main.apps.MainConfig',     # New app , check referenced class inside main/apps.py
    'crispy_forms',
    'crispy_bootstrap5',    
]

# Set Boostrap4 as default styling framework.
